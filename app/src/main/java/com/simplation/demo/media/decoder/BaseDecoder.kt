package com.simplation.demo.media.decoder

import android.media.MediaCodec
import android.media.MediaFormat
import android.util.Log
import com.simplation.demo.media.DecodeState
import com.simplation.demo.media.IDecoder
import com.simplation.demo.media.IDecoderProgress
import com.simplation.demo.media.IDecoderStateListener
import com.simplation.demo.media.IExtractor
import java.io.File
...
abstract class BaseDecoder(private val mFilePath: String) : IDecoder {
    ...
    private fun initCodec(): Boolean {
        try {
            val type = mExtractor!!.getFormat()!!.getString(MediaFormat.KEY_MIME) as String
